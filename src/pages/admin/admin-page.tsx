      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new invoice for a guest. Fill in all the required
              details.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new food order for a guest. Select items from the menu.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="samira">
                    Samira Karki - Room 205
                  </SelectItem>
